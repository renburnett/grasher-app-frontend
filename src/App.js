...
const App = () => {
  ...
  const setUserAndJwtToLocalStorage = (
    ...
    <div className="App">
      <Router>
        ...
        <Route
          ...
          render={() => (
            <FridgesContainer
              fetchUsersFridges={state.fetchUsersFridges}
              fridgesReady={state.currentUsersFridges.length > 0}
              currentUsersFridges={state.currentUsersFridges}
        ...
        <Switch>
          <Route path="/login">
            {state.currentUser ? (
              ...
              (props) => (
                <Login
                  {...props}
                  handleLoginSubmit={(props) => handleLoginSubmit(props, state)}
          ...
          <Route
            ...
            render={(props) => (
              <Signup
                {...props}
                setUserAndJwtToLocalStorage={setUserAndJwtToLocalStorage}
              />
            )}
          />
        </Switch>
        ...
        <Route
          exact
          path="/new_fridge"
          render={(props) => <NewFridgeForm {...props} />}
        />
        <Route
